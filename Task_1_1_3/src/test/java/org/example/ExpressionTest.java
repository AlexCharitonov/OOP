...
class ExpressionTest {
    ...
    void testAddDerivative() {
        Expression expr = new Add(new Mul(new org.example.expression.Number(5), new Variable("x")),
                new Variable("x"));
        Expression ans = new Add(new Add(new Mul(new org.example.expression.Number(0), new Variable("x")),
                new Mul(new org.example.expression.Number(5), new org.example.expression.Number(1))), new org.example.expression.Number(1));
        Assertions.assertTrue(ans.equals(expr.derivative("x")));
    }

    @Test
    void testSubDerivative() {
        Expression expr = new Sub(new Mul(new org.example.expression.Number(5), new Variable("x")),
                new Variable("x"));
        Expression ans = new Sub(new Add(new Mul(new org.example.expression.Number(0), new Variable("x")),
                new Mul(new org.example.expression.Number(5), new org.example.expression.Number(1))), new org.example.expression.Number(1));
        Assertions.assertTrue(ans.equals(expr.derivative("x")));
    }
    ...
    void testDivDerivative() {
        ...
        Expression ans = new Div(new Sub(new Mul(new org.example.expression.Number(1), new Variable("y")),
                new Mul(new Variable("x"), new org.example.expression.Number(0))), new Mul(new Variable("y"),
                new Variable("y")));
        Assertions.assertTrue(ans.equals(expr.derivative("x")));
    }
    ...
    void testSimplification() {
        ...
        Expression simply = new Div(new org.example.expression.Number(13220), new Variable("x"));
